...
public class GroupController {
    ...
    public ModelAndView saveNewMember(@PathVariable("id") long groupId,
                                      @RequestParam("email") String email,
                                      Model model) {
        String result = groupService.addNewMemberToGroup(groupId, email);

        switch (result) {
            case "success" -> model.addAttribute("successMessage", "Member added successfully.");
    ...
    public ModelAndView saveTodoItem(@PathVariable(value = "id") long id, @ModelAttribute("todoitem") TodoItemDTO todoItem) {
    ...
    public ModelAndView updateGroupTodoItem(@PathVariable(value = "groupId") Long groupId,
                                            @ModelAttribute("todoitem") TodoItemDTO todoItem) {
...
//            groupService.updateTodoItem(todoItem);
...
//        groupService.saveGroupTodoItem(todoItem, groupId);
    ...
    public ModelAndView deleteGroupTodoItem(@PathVariable(value = "groupId") long groupId, @PathVariable(value = "id") String id) {
    ...
    public ModelAndView findPaginatedTodoItemByGroup(
        ...
        Page<TodoItemDTO> page = groupService.findPaginatedTodoItemInGroup(id, pageNo, pageSize, sortField, sortDir);
        List<TodoItemDTO> groupTodoItems = page.getContent();
