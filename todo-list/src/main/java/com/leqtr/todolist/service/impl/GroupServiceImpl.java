...
public class GroupServiceImpl implements GroupService {
    ...
    public String addNewMemberToGroup(Long groupId, String email) {
        ...
        List<GroupRole> groupRoles = userToAdd.getGroupRoles();
        ...
        List<GroupRole> userGroupRole = userToAdd.getGroupRoles();
        userGroupRole.add(newGroupRole);
        userRepository.save(userToAdd);

        List<GroupRole> groupGroupRole = group.getGroupRoles();
    ...
    public void leaveGroup(long id) {
        ...
        List<GroupRole> groupRoles = curUser.getGroupRoles();
        for (GroupRole groupRole : groupRoles) {
...
//            List<GroupRole> groupRoles = groupRoleRepository.findAll();
            ...
            List<GroupRole> curUserGroupRoles = curUser.getGroupRoles();
    ...
    public void saveGroupTodoItem(TodoItemDTO todoItem, Long id) {
        ...
        todoItemClient.createTodoItem(todoItem);
    }
